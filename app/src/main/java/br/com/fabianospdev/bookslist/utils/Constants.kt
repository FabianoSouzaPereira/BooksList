...
object Constants {
    ...
    object Endpoint {
        const val GET_BOOKS = "${API_SERVER_NAME}${PREFIX}${PARAM_VOLUMES}"
        ...
        const val GET_VOLUMES_SHELF =
            "${API_SERVER_NAME}${PREFIX}${PARAM_MYLIBRARY}/${PARAM_BOOKSHELVES}/${PARAM_SHELF}"
        const val GET_BOOKSHELVES_VOLUMES =
            "${API_SERVER_NAME}${PREFIX}${PARAM_MYLIBRARY}/${PARAM_BOOKSHELVES}/${PARAM_SHELF}/${PARAM_VOLUMES}"
    }
}